    ...
    <div className="flex min-h-screen items-center justify-center theme-bg-primary">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-3xl font-bold theme-text-primary">Sign In</h1>
          <p className="theme-text-secondary">Sign in with your Yahoo account to access your fantasy leagues</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="theme-bg-secondary px-2 theme-text-secondary">Or continue with email</span>
              </div>
            </div>
